...
| 11 | 仓库可见性（W4 期） | **转 private**（2026-09-13 用户拍板）。代价：CI 从"公开无限"变配额制（Free 档 2000 分钟/月，macOS ×10 倍率，实测一轮全量 CI ≈170 分钟 → ~11 轮/月），纪律见 DevWorkflow §2.2。v1.0 发布前的可见性/许可策略待再拍板 |
